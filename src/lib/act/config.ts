// Auto-generated shim — re-exports from @/lib/delf/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _delf_Config } from "@/lib/delf/config";
import { EXAM_CONFIG as _raw } from "@/lib/delf/config";
