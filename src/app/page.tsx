...
export const metadata: Metadata = {
  title: "Koydo DELF — Free Exam Prep",
  description: "Comprehensive DELF preparation. Practice tests, AI tutor, score tracking. This app is a study aid based on publicly available syllabus and exam patterns. Not affiliated with any official examination authority.",
};
    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-5xl px-4 py-16">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            { icon: "📝", title: "Practice Tests", desc: "Hundreds of practice questions matching the real DELF format." },
